...
.controller('BodyController', ["$scope", "UserFactory", "Page", function($scope, UserFactory, Page) {
	$scope.Page = Page;
...
angular.module('app.core')
.controller('GroupsController', ["$scope", "Group", "Page", function($scope, Group, Page) {
...
angular.module('app.group')
.controller('GroupController', ["$scope", "$location", "$routeParams", "$route", "Group", "Page", function($scope, $location, $routeParams, $route, Group, Page){
...
angular.module('app.user')
.controller('UserController', ["$scope", "$routeParams", "User", "Page", function($scope, $routeParams, User, Page) {
