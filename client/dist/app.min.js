...
angular.module('app.core')
.controller('SignupController', ["$scope", "Title", function($scope, Title) {
	Title.set('Sign Up');
}]);
...
.controller('UserEditController', ["$scope", "$routeParams", "User", "$location", "Title", function($scope, $routeParams, User, $location, Title){
